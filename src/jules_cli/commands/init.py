...
def cmd_init():
    ...
    # 1. Ask for API Key
    api_key = typer.prompt("Enter your Jules API Key", default=os.getenv("JULES_API_KEY", ""), show_default=False, hide_input=True)

    # 2. Ask for GitHub Token
    github_token = typer.prompt("Enter your GitHub Token", default=os.getenv("GITHUB_TOKEN", ""), show_default=False, hide_input=True)
