...
from jules_cli.commands import commit

@patch('jules_cli.commands.commit.git_create_branch_and_commit')
@patch('jules_cli.commands.commit.git_push_branch')
...
@patch('jules_cli.commands.commit.git_create_branch_and_commit', side_effect=Exception("Commit failed"))
...
@patch('jules_cli.commands.commit.git_create_branch_and_commit')
@patch('jules_cli.commands.commit.git_push_branch', side_effect=Exception("Push failed"))
