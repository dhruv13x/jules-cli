...
from jules_cli.commands.testgen import run_testgen
import os
...
@patch("jules_cli.commands.testgen.config")
@patch("jules_cli.commands.testgen.pick_source_for_repo")
@patch("jules_cli.commands.testgen.create_session")
@patch("jules_cli.commands.testgen.poll_for_result")
...
@patch("jules_cli.commands.testgen.config")
@patch("jules_cli.commands.testgen.pick_source_for_repo", return_value=None)
def test_run_testgen_no_source(mock_pick, mock_config):
    mock_config.get_nested.return_value = "test_repo"
    with patch("jules_cli.commands.testgen.list_sources", return_value=[]) as mock_list_sources:
        try:
            run_testgen("my_file.py")
        except RuntimeError:
            pass
...
@patch("jules_cli.commands.testgen.config")
@patch("jules_cli.commands.testgen.pick_source_for_repo")
@patch("jules_cli.commands.testgen.create_session", return_value={})
