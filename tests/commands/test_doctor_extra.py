...
@patch('src.jules_cli.commands.doctor.run_cmd', return_value=(0, "changes", ""))
...
@patch('src.jules_cli.commands.doctor.logger')
def test_run_doctor_command_json(mock_logger):
    with patch('src.jules_cli.commands.doctor.check_jules_api_key', return_value='ok'), \
