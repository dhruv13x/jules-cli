...
from jules_cli.commands.refactor import run_refactor
import os
...
@patch("jules_cli.commands.refactor.config")
@patch("jules_cli.commands.refactor.pick_source_for_repo")
@patch("jules_cli.commands.refactor.create_session")
@patch("jules_cli.commands.refactor.poll_for_result")
@patch("jules_cli.commands.refactor.send_message")
...
@patch("jules_cli.commands.refactor.config")
@patch("jules_cli.commands.refactor.pick_source_for_repo", return_value=None)
def test_run_refactor_no_source(mock_pick, mock_config):
    mock_config.get_nested.return_value = "test_repo"
    with patch("jules_cli.commands.refactor.list_sources", return_value=[]) as mock_list_sources:
        try:
            run_refactor("my instruction")
        except RuntimeError:
            pass
...
@patch("jules_cli.commands.refactor.config")
@patch("jules_cli.commands.refactor.pick_source_for_repo")
@patch("jules_cli.commands.refactor.create_session", return_value={})
