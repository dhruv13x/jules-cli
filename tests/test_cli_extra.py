...
def test_auto_command():
    with patch('src.jules_cli.cli.auto_fix_command') as mock_auto_fix_command, \
...
def test_session_list_command():
    with patch('src.jules_cli.cli.cmd_session_list') as mock_cmd_session_list, \
         patch('src.jules_cli.cli.check_env'), \
         patch('src.jules_cli.cli.init_db'):
...
def test_session_show_command():
    with patch('src.jules_cli.cli.cmd_session_show') as mock_cmd_session_show, \
         patch('src.jules_cli.cli.check_env'), \
         patch('src.jules_cli.cli.init_db'):
...
def test_commit_command():
    with patch('src.jules_cli.cli.cmd_commit_and_push') as mock_cmd_commit_and_push, \
         patch('src.jules_cli.cli.check_env'), \
         patch('src.jules_cli.cli.init_db'):
...
def test_push_command():
    with patch('src.jules_cli.cli.git_current_branch', return_value='my-branch') as mock_git_current_branch, \
         patch('src.jules_cli.cli.git_push_branch') as mock_git_push_branch, \
         patch('src.jules_cli.cli.check_env'), \
         patch('src.jules_cli.cli.init_db'):
...
def test_doctor_command():
    with patch('src.jules_cli.cli.run_doctor_command') as mock_run_doctor_command, \
         patch('src.jules_cli.cli.check_env'), \
         patch('src.jules_cli.cli.init_db'):
...
def test_main_jules_error():
    with patch('src.jules_cli.cli.check_env', side_effect=JulesError("test error")) as mock_check_env, \
         patch('src.jules_cli.cli.init_db'), \
         patch('src.jules_cli.cli.logger') as mock_logger:
